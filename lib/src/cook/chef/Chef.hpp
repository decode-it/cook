...
#include "cook/chef/Instruction.hpp"
...
public:
    ...
    Result prepare_context(assistant::Context & context, model::Recipe * recipe, const model::Menu & menu, model::Environment * environment);

private:
    Result mis_en_place_(Kitchen & kitchen, const assistant::Context & context, const Instructions &instructions) const;
